 ...
 * generated in the com.mycuteblog.service package. 
...
public class ObjectFactory {
    ...
    private final static QName _GetBooks_QNAME = new QName("http://service.mycuteblog.com/", "getBooks");
    private final static QName _GetBooksResponse_QNAME = new QName("http://service.mycuteblog.com/", "getBooksResponse");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: com.mycuteblog.service
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://service.mycuteblog.com/", name = "getBooks")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://service.mycuteblog.com/", name = "getBooksResponse")
